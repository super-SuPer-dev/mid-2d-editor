...
const LEVELS := {
	...
	"level_02": {
		...
		"pacing_budget_seconds": {"briefing": 45, "traversal": 75, "encounters": 150, "boss": 90, "extraction": 15},
		"encounter_contracts": [
			{"encounter_id": "canopy_entry", "x_range": Vector2(120, 1100), "threat_count": 2},
			{"encounter_id": "spore_clearing", "x_range": Vector2(1100, 2200), "threat_count": 2},
			{"encounter_id": "bloom_approach", "x_range": Vector2(2200, 2990), "threat_count": 1},
		],
	...
	"level_03": {
		...
		"pacing_budget_seconds": {"briefing": 45, "traversal": 75, "encounters": 150, "boss": 90, "extraction": 15},
		"encounter_contracts": [
			{"encounter_id": "root_entry", "x_range": Vector2(120, 850), "threat_count": 2},
			{"encounter_id": "shell_rift", "x_range": Vector2(850, 1650), "threat_count": 2},
			{"encounter_id": "harvester_approach", "x_range": Vector2(1650, 2350), "threat_count": 1},
		],
	...
	"level_04": {
		...
		"pacing_budget_seconds": {"briefing": 45, "traversal": 75, "encounters": 150, "boss": 90, "extraction": 15},
		"encounter_contracts": [
			{"encounter_id": "reed_entry", "x_range": Vector2(120, 900), "threat_count": 2},
			{"encounter_id": "conduit_crossing", "x_range": Vector2(900, 1800), "threat_count": 2},
			{"encounter_id": "hydra_approach", "x_range": Vector2(1800, 3020), "threat_count": 2},
		],
	...
	"level_05": {
		...
		"pacing_budget_seconds": {"briefing": 45, "traversal": 75, "encounters": 150, "boss": 90, "extraction": 15},
		"encounter_contracts": [
			{"encounter_id": "nexus_entry", "x_range": Vector2(120, 900), "threat_count": 2},
			{"encounter_id": "lattice_crossing", "x_range": Vector2(900, 1800), "threat_count": 2},
			{"encounter_id": "eye_approach", "x_range": Vector2(1800, 3180), "threat_count": 2},
		],
