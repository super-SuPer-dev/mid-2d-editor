...
const LEVELS := {
	...
	"level_02": {
		...
		"size": Vector2(3300, 800), "threat_quota": 6, "required_kills": 6, "sample_target": 8,
	...
	"level_04": {
		...
		"size": Vector2(3400, 800), "threat_quota": 7, "required_kills": 7, "sample_target": 8,
	...
	"level_05": {
		...
		"size": Vector2(3600, 850), "threat_quota": 8, "required_kills": 8, "sample_target": 10,
