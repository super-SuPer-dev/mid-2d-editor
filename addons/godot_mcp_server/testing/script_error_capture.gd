...
##
## Source: ported from godot-ai (D:\GitHub\godot-ai\plugin\addons\godot_ai\testing\script_error_capture.gd).
## Enhanced variant: byte-identical, zero external dependencies.
