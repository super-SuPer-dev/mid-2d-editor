...
| Provenance records | Incomplete | 40 Markdown generation/provenance records exist, but the audit did not establish one-to-one coverage for all 474 PNG files |
