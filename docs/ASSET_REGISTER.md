...
| BOSS-ROOT-HYDRA | 4 | Nipa-palm fruit cluster | P0 | Fruit-identity strip, complete eleven-action true-alpha body source contract and seven detached projectile/telegraph/impact sets are in Review at `Generated-Assets/bosses/root_hydra/`: 44 body frames plus wedge crossfire, nutrient-ring orbs, muzzle/ring tells, water-lane eruption and exposed-core beam/impact establish the four-origin Touhou-style pattern language; presentation, runtime integration, final VFX/SFX and gameplay validation remain | Review |
