...
|---|---|---|---:|---|---|---|
| ENEMY-THORNLING | Thornling | Rambutan / เงาะ | P0 | Detailed true-alpha six-action body plus a detached four-frame rambutan contact-hit VFX source are in Review at `art_source/generated/enemies/thornling/`; idle/run strips are promoted at `assets/enemies/standard/thornling/` with 700 × 800 cells, 740 px baseline, binary alpha, nearest filtering and deterministic grounded animation. Attack tell, attack, hurt, death, contact-hit VFX, gameplay tuning and human art review remain open; see the English provenance record. | Idle/run, attack tell, attack, hurt, death, contact-hit VFX | Integrated |
| ENEMY-SPITTER | Spitter | Makrut lime / มะกรูด | P0 | Detailed true-alpha seven-action body plus four detached makrut seed/glob/impact VFX strips are in Review at `art_source/generated/enemies/spitter/`; idle/walk strips are promoted at `assets/enemies/standard/spitter/` with 700 × 800 cells, 740 px baseline, binary alpha, nearest filtering and deterministic grounded animation. Pressure tell, seed burst, juice lob, hurt, death, VFX, gameplay tuning and human art review remain open; see the English provenance record. | Idle/walk, pressure tell, seed burst, juice lob, hurt, death, seed/glob/impact VFX | Integrated |
