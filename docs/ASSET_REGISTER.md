...
| BOSS-ROOT-CORE-EYE | 5 | Longan eye cluster + dragon-fruit bracts | P0 | Fruit-identity sources and first six true-alpha four-frame body actions are in Review at `Generated-Assets/bosses/root_core_eye/`: sealed idle, awakening, aimed seed cast, spiral cast, bract curtain and radial-ring cast establish eight readable longan-eye origins and dragon-fruit directional bracts; beam/exposed-core/hurt/death actions, projectiles/hazards, presentation, runtime integration, VFX/SFX and gameplay validation remain | Review |
