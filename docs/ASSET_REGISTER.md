...
| WORLD-L3-CAPSULE | Capsule 07 impact/root chamber | P0 | A detailed high-resolution pixel-art source package is in Review at `Generated-Assets/world/level_03_capsule_07/`: five-layer cavern/shell parallax stack, seven-piece modular capsule-root tile source set with mirrored/rotated derivatives specified, animated santol seed-piston hazard, root-chamber extraction beacon and Capsule 07 seed-harvester landmark; alpha/hash/provenance evidence is recorded, while runtime slicing, collisions, placement, memory and 1280 × 720 gameplay validation remain | Review |
| WORLD-L4-MARSH | Devouring Root Marsh environment | P0 | A detailed high-resolution pixel-art source package is in Review at `Generated-Assets/world/level_04_root_marsh/`: five-layer marsh/nipa/nutrient-conduit parallax stack, seven-piece modular root-mat tile source set with mirrored/rotated derivatives specified, animated four-frame nutrient-root eruption, stilted extraction beacon, and Root Nutrient Conduit landmark; alpha/hash/provenance evidence is recorded, while runtime slicing, collisions, placement, memory and 1280 × 720 gameplay validation remain | Review |
| WORLD-L5-NEXUS | Alien Eye Nexus environment | P0 | A detailed high-resolution pixel-art source package is in Review at `Generated-Assets/world/level_05_alien_eye_nexus/`: five-layer impossible-depth/longan-eye/dragon-bract parallax stack, seven-piece modular membrane and neural-root tile source set with mirrored/rotated derivatives specified, animated four-frame sensory platform collapse, clamped extraction beacon, and Awakened Sensory Nexus landmark; alpha/hash/provenance evidence is recorded, while runtime slicing, collisions, placement, projectile readability, memory and 1280 × 720 gameplay validation remain | Review |
| LANDMARK-CAPSULE-07 | Capsule shell and subterranean seed | P0 | Detailed true-alpha Capsule 07 seed-harvester landmark source is in Review at `Generated-Assets/world/level_03_capsule_07/landmarks/capsule_07_seed_harvester_v1.png`; it exposes the santol-like germination core, shell/scaffold silhouette and downward harvester roots without baked text, while runtime scale, placement, occlusion and midpoint reveal validation remain | Review |
| LANDMARK-ROOT-CONDUIT | Marsh nutrient conduit | P1 | Detailed source candidate is included in `Generated-Assets/world/level_04_root_marsh/landmarks/root_nutrient_conduit_v1.png`; irrigation-gate scale, traversable lower passage, salak/nipa context and provenance are documented, while runtime placement, collision/readability and performance validation remain | Review |
| LANDMARK-ALIEN-EYE | Awakened sensory nexus | P0 | Detailed true-alpha source candidate is included in `Generated-Assets/world/level_05_alien_eye_nexus/landmarks/awakened_sensory_nexus_v1.png`; longan seed-eye, dragon-fruit bract iris, biomass arteries, lower passage, hash and provenance are documented, while runtime scale, placement, occlusion, projectile readability and performance validation remain | Review |
