...
| BOSS-POSSESSED-BANYAN | 3 | Jackfruit + banyan fig | P0 | Detailed true-alpha thirteen-action body source set is in Review at `Generated-Assets/bosses/possessed_banyan/`: armored/exposed idles, movement, charge and root-sweep tells/attacks, seed-column/diagonal-root/sap casts, phase break, hurt and progressive death on 900 x 900 cells; fruit identity sheet, normalized grids, hashes and provenance are recorded; detached projectiles/hazards, presentation, runtime integration, VFX/SFX and gameplay validation remain | Review |
...
| UI-BOSS-HUD | Boss name, phase and health | P0 | Text-free Thorn Matriarch and Maw Sovereign frames, portrait states and phase markers are in Review under their `Generated-Assets/bosses/*/presentation/` packages; reusable runtime component and three boss skins remain | Review |
| UI-BOSS-INTRO | Boss introduction treatment | P1 | Text-free Thorn Matriarch and Maw Sovereign intro frames and portrait states are in Review under their presentation packages; reusable localized presentation and three boss skins remain | Review |
