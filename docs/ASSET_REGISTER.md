...
| BOSS-ROOT-CORE-EYE | 5 | Longan eye cluster + dragon-fruit bracts | P0 | Complete fruit-identity, thirteen-action/52-frame true-alpha body contract and seven detached projectile/telegraph/impact strips are in Review at `Generated-Assets/bosses/root_core_eye/`; five crown-eye origins plus the central pupil support seed volleys, spiral orbs, bract curtains, radial tells, beam and exposed-core shockwave with normalized grids, hashes and provenance; presentation, runtime integration, final VFX/SFX and gameplay validation remain | Review |
