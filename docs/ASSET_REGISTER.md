...
| BOSS-ROOT-CORE-EYE | 5 | Longan eye cluster + dragon-fruit bracts | P0 | Complete fruit-identity and thirteen-action/52-frame true-alpha body source contract is in Review at `Generated-Assets/bosses/root_core_eye/`; sealed/awakened/exposed phases, five readable crown-eye origins plus the central pupil, dragon-fruit directional bracts, beam tells, hurt and permanent grounded death are documented with normalized grids, hashes and provenance; projectiles/hazards, presentation, runtime integration, VFX/SFX and gameplay validation remain | Review |
...
| UI-BOSS-HUD | Boss name, phase and health | P0 | Text-free Thorn Matriarch, Maw Sovereign, Possessed Banyan and Root Hydra frames, portrait states and phase markers are in Review under their `Generated-Assets/bosses/*/presentation/` packages; reusable runtime component and the Root-Core Eye skin remain | Review |
| UI-BOSS-INTRO | Boss introduction treatment | P1 | Text-free Thorn Matriarch, Maw Sovereign, Possessed Banyan and Root Hydra intro frames and portrait states are in Review under their presentation packages; reusable localized presentation and the Root-Core Eye skin remain | Review |
