...
| ENEMY-ROOT-SKITTER | Root Skitter | Salak / สละ | P1 | Detailed true-alpha seven-action source set at `art_source/generated/enemies/root_skitter/`; normalized 4 x 1 strips use 700 x 800 cells and baseline 740; runtime integration remains | Idle/scuttle, burrow tell, burrow, emerge attack, hurt, death | Review |
...
| WORLD-L4-MARSH | Devouring Root Marsh environment | P0 | Corrected authentic pixel-art v2 package is in Review at `art_source/generated/world/level_04_root_marsh/`: five marsh/nipa/conduit layers, seven modular root-mat sources, four-frame nutrient-root eruption, extraction beacon and conduit landmark; visible square pixels, stepped edges, limited ramps, alpha, frame gutters, hashes and rejection of painted v1 are documented, while runtime slicing, collision, filtering, placement, memory and 1280 × 720 validation remain | Review |
| WORLD-L5-NEXUS | Alien Eye Nexus environment | P0 | Corrected authentic pixel-art v2 package is in Review at `art_source/generated/world/level_05_alien_eye_nexus/`: five-layer impossible-depth/longan-eye/dragon-bract stack, seven modular membrane/neural-root sources, animated four-frame sensory platform, extraction beacon and nexus landmark; visible square-pixel construction, hard stepped edges, limited ramps, alpha, frame gutters, hashes and rejection of painted v1 are documented, while runtime slicing, collisions, filtering, placement, projectile readability, memory and 1280 × 720 validation remain | Review |
...
| LANDMARK-ROOT-CONDUIT | Marsh nutrient conduit | P1 | Authentic pixel-art true-alpha candidate is `art_source/generated/world/level_04_root_marsh/landmarks/root_nutrient_conduit_v2.png`; irrigation-gate scale, lower passage, salak/nipa context, hash and v1 rejection are documented, while runtime placement, collision/readability and performance validation remain | Review |
| LANDMARK-ALIEN-EYE | Awakened sensory nexus | P0 | Authentic pixel-art true-alpha candidate is `art_source/generated/world/level_05_alien_eye_nexus/landmarks/awakened_sensory_nexus_v2.png`; longan seed-eye, dragon-fruit bract iris, biomass arteries, lower passage, hash and v1 rejection are documented, while runtime scale, placement, occlusion, projectile readability and performance validation remain | Review |
