...
| ENEMY-SPITTER | Spitter | Makrut lime / มะกรูด | P0 | Detailed true-alpha seven-action body plus four detached makrut seed/glob/impact VFX strips are recorded at `art_source/generated/enemies/spitter/`; idle/walk, pressure-tell → seed-burst and hurt strips are promoted at `assets/enemies/standard/spitter/` with 700 × 800 cells, 740 px baseline, binary alpha, nearest filtering and deterministic 4/7/8 fps presentation. Juice lob/death presentation, VFX, gameplay tuning and human art review remain open; see the English provenance record. | Idle/walk, seed-burst cast, pressure tell, juice lob, hurt, death, seed/glob/impact VFX | Integrated |
