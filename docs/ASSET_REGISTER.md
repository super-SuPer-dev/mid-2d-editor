...
| WORLD-L1-GRASSLAND | Contaminated Grassland environment | P0 | Generated 1672 × 941 pixel-art backdrop plus true-alpha irrigation-root tower landmark at `art_source/generated/world/level_01_contaminated_grassland/`; runtime pilots are `assets/world/level_01_contaminated_grassland/parallax/grassland_backdrop_v1.png` and `landmarks/irrigation_root_tower_v1.png`, wired through `scenes/backgrounds/grassland_generated_parallax.tscn` and the Level 1 environment | Integrated |
