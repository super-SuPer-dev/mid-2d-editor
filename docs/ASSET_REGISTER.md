...
| BOSS-MAW-SOVEREIGN | 2 | Durian crown + mangosteen anatomy | P0 | Detailed true-alpha twelve-action body plus five detached projectile/hazard source sets are in Review at `Generated-Assets/bosses/maw_sovereign/`: spore pod/fall/puddle, spinning seed/impact and summon root nest join the armored/exposed body contract; fruit identity sheet, normalized grids, hashes and provenance are recorded; portrait/HUD, runtime integration, final VFX/SFX and gameplay validation remain | Review |
