...
| ENEMY-ROOT-SKITTER | Root Skitter | Salak / สละ | P1 | Seven-action source set at `art_source/generated/enemies/root_skitter/` is promoted to a full quantized runtime action contract at `assets/enemies/standard/root_skitter/`; idle/scuttle plus burrow-tell → burrow → emerge-attack, hurt and delayed death use 4 × 700 × 800 cells, 740 px baseline, binary alpha, nearest filtering and deterministic 5.5/8 fps presentation. Human silhouette, motion and combat-scale review remain open; see the English provenance record in the runtime folder. | Idle, scuttle, burrow tell, burrow, emerge attack, hurt, death | Integrated |
...
| ENEMY-MIXED-ELITE | Mixed Elite remix | Santol shell + longan eye | P1 | Level 5 runtime composite: the promoted Capsule Husk body is paired with a synchronized Eye Wisp overlay through `VisualAccent`. It reuses both validated four-frame strips, keeps the Capsule Husk collision/combat contract, and introduces no new source package or placeholder dependency. | Composite idle/move, charge-tell, core-attack, hurt, death presentation | Integrated |
...
|---|---:|---|---:|---|---|
| BOSS-THORN-MATRIARCH | 1 | Rambutan queen cluster | P0 | Detailed true-alpha nine-action body, rolling mine/burst, spinning hair-thorn/impact, telegraphed lane hazard, three-state portrait, intro/HUD frames and phase markers are in Review at `art_source/generated/bosses/thorn_matriarch/`; armored/exposed idle, sweep-tell, sweep-attack, fan-cast, mine-cast, hurt, phase-break, four-frame death and pattern-specific hair-thorn/lane-thorn projectile strips are promoted at `assets/enemies/bosses/thorn_matriarch/` with nearest filtering, binary alpha, 840 px baseline and pattern-signal binding. Presentation art, detached impact VFX/SFX and human boss-feel review remain open; see the English provenance records. | Integrated |
| BOSS-MAW-SOVEREIGN | 2 | Durian crown + mangosteen anatomy | P0 | Detailed true-alpha twelve-action body, five detached projectile/hazard sets, three-state portrait strip, intro/HUD frames and phase markers are in Review at `art_source/generated/bosses/maw_sovereign/`; armored/exposed idle, spore, rotating-volley, aimed-volley, three-frame death and pattern-specific spore-pod/seed-spin projectile strips are promoted at `assets/enemies/bosses/maw_sovereign/` with nearest filtering, binary alpha, 840 px baseline and pattern-signal binding. Presentation art, detached impact VFX/SFX and human boss-feel review remain open; see the English provenance record. | Integrated |
| BOSS-POSSESSED-BANYAN | 3 | Jackfruit + banyan fig | P0 | Detailed true-alpha thirteen-action body, six detached projectile/hazard/death-VFX sets, and a text-free presentation package are in Review at `art_source/generated/bosses/possessed_banyan/`; armored/exposed idle, seed-column, diagonal-root cast, three-frame death and pattern-specific jackfruit-seed/diagonal-root projectile strips are promoted at `assets/enemies/bosses/possessed_banyan/` with nearest filtering, binary alpha, 840 px baseline and pattern-signal binding. Presentation art, detached impact VFX/SFX and human boss-feel review remain open; see the English provenance record. | Integrated |
| BOSS-ROOT-HYDRA | 4 | Nipa-palm fruit cluster | P0 | Complete fruit-identity, eleven-action/44-frame body, seven detached projectile/telegraph/impact sets and text-free presentation package remain in Review at `art_source/generated/bosses/root_hydra/`; armored/exposed idle, crossfire, radial-ring, lane-wall cast, hurt, four-frame death and pattern-specific nipa-wedge/nutrient-orb/water-lane projectile strips are promoted at `assets/enemies/bosses/root_hydra/` with 1000 × 900 cells, 840 px baseline, binary alpha, nearest filtering, phase-2 exposure, damage-priority hurt playback, pattern-signal binding and shared non-blocking defeat lifecycle. Presentation art, audio and human boss-feel review remain open; see the English provenance record. | Integrated |
| BOSS-ROOT-CORE-EYE | 5 | Longan eye cluster + dragon-fruit bracts | P0 | Complete fruit-identity, thirteen-action/52-frame body contract, seven detached projectile/telegraph/impact strips and text-free presentation package remain in Review at `art_source/generated/bosses/root_core_eye/`; sealed/exposed idle, spiral, aimed-seed, bract-curtain cast, four-frame longan-seed projectile, hurt, four-frame death and pattern-specific spiral-orb/pupil-dart/bract-blade projectile strips are promoted at `assets/enemies/bosses/root_core_eye/` with binary alpha, nearest filtering, phase-2 exposure, damage-priority hurt playback, pattern-signal binding, pooled reset coverage and shared non-blocking defeat lifecycle. Presentation art, audio and human final-boss review remain open; see the English provenance record. | Integrated |
