...
| WORLD-L5-NEXUS | Alien Eye Nexus environment | P0 | Corrected authentic pixel-art v2 package is in Review at `Generated-Assets/world/level_05_alien_eye_nexus/`: five-layer impossible-depth/longan-eye/dragon-bract stack, seven modular membrane/neural-root sources, animated four-frame sensory platform, extraction beacon and nexus landmark; visible square-pixel construction, hard stepped edges, limited ramps, alpha, frame gutters, hashes and rejection of painted v1 are documented, while runtime slicing, collisions, filtering, placement, projectile readability, memory and 1280 × 720 validation remain | Review |
...
| LANDMARK-ALIEN-EYE | Awakened sensory nexus | P0 | Authentic pixel-art true-alpha candidate is `Generated-Assets/world/level_05_alien_eye_nexus/landmarks/awakened_sensory_nexus_v2.png`; longan seed-eye, dragon-fruit bract iris, biomass arteries, lower passage, hash and v1 rejection are documented, while runtime scale, placement, occlusion, projectile readability and performance validation remain | Review |
