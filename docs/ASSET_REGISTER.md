...
| BOSS-ROOT-HYDRA | 4 | Nipa-palm fruit cluster | P0 | Fruit-identity strip and first five true-alpha four-frame body actions are in Review at `Generated-Assets/bosses/root_hydra/`: idle, head-charge tell, alternating crossfire, offset radial-ring cast and moving lane-wall cast establish four readable projectile origins and a planted baseline; head-break/exposed-core/hurt/death actions, detached projectiles/hazards, presentation, runtime integration, VFX/SFX and gameplay validation remain | Review |
...
| UI-BOSS-HUD | Boss name, phase and health | P0 | Text-free Thorn Matriarch, Maw Sovereign and Possessed Banyan frames, portrait states and phase markers are in Review under their `Generated-Assets/bosses/*/presentation/` packages; reusable runtime component and two boss skins remain | Review |
| UI-BOSS-INTRO | Boss introduction treatment | P1 | Text-free Thorn Matriarch, Maw Sovereign and Possessed Banyan intro frames and portrait states are in Review under their presentation packages; reusable localized presentation and two boss skins remain | Review |
