...
| BOSS-ROOT-HYDRA | 4 | Nipa-palm fruit cluster | P0 | Fruit-identity strip and complete eleven-action true-alpha body source contract are in Review at `Generated-Assets/bosses/root_hydra/`: 44 frames cover armored/exposed idles, charge/crossfire/ring/lane casts, head and phase breaks, core attack, hurt and permanent death pose with four readable projectile origins and a planted baseline; detached projectiles/hazards, presentation, runtime integration, VFX/SFX and gameplay validation remain | Review |
