...
| BOSS-POSSESSED-BANYAN | 3 | Jackfruit + banyan fig | P0 | Detailed true-alpha thirteen-action body plus six detached projectile/hazard/death-VFX sets are in Review at `Generated-Assets/bosses/possessed_banyan/`: falling jackfruit seed, impact, ground tell, diagonal fig-root line, sticky sap pool and heart break complete the body contract; fruit identity sheet, normalized grids, hashes and provenance are recorded; presentation, runtime integration, final VFX/SFX and gameplay validation remain | Review |
