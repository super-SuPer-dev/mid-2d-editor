...
| LANDMARK-ALIEN-EYE | sensory nexus | candidate pixel art แท้จริงแบบ true-alpha คือ `Generated-Assets/world/level_05_alien_eye_nexus/landmarks/awakened_sensory_nexus_v2.png`; บันทึกตาเมล็ดลำไย ม่านตากลีบแก้วมังกร สาย biomass ทางผ่านด้านล่าง hash และการ reject v1 แล้ว แต่ยังขาด runtime scale, placement, occlusion, projectile readability และ performance validation | Review |
