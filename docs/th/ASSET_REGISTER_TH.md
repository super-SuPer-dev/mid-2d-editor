...
| WORLD-L4-MARSH | Devouring Root Marsh | ชุด source pixel art รายละเอียดสูงอยู่ใน Review ที่ `Generated-Assets/world/level_04_root_marsh/` มี parallax หนองน้ำ/nipa/nutrient conduit 5 ชั้น, tile source root-mat แบบ modular 7 ชิ้นพร้อมข้อกำหนด variant mirror/rotate, hazard nutrient-root eruption แบบ animation 4 เฟรม, extraction beacon บนเสา และ Root Nutrient Conduit landmark; บันทึก alpha/hash/provenance แล้ว แต่ยังขาด runtime slicing, collision, placement, memory และ gameplay validation ที่ 1280 × 720 | Review |
| WORLD-L5-NEXUS | Alien Eye Nexus | ชุด source pixel art รายละเอียดสูงอยู่ใน Review ที่ `Generated-Assets/world/level_05_alien_eye_nexus/` มี parallax impossible depth/ตาลำไย/กลีบแก้วมังกร 5 ชั้น, tile source membrane และ neural-root แบบ modular 7 ชิ้นพร้อมข้อกำหนด variant mirror/rotate, sensory platform collapse แบบ animation 4 เฟรม, extraction beacon ที่ยึดกับ network และ Awakened Sensory Nexus landmark; บันทึก alpha/hash/provenance แล้ว แต่ยังขาด runtime slicing, collision, placement, projectile readability, memory และ gameplay validation ที่ 1280 × 720 | Review |
...
| LANDMARK-ROOT-CONDUIT | nutrient conduit | source candidate รายละเอียดสูงอยู่ที่ `Generated-Assets/world/level_04_root_marsh/landmarks/root_nutrient_conduit_v1.png`; บันทึก scale ของประตูชลประทาน ทางผ่านด้านล่าง บริบทสละ/nipa และ provenance แล้ว แต่ยังขาด runtime placement, collision/readability และ performance validation | Review |
| LANDMARK-ALIEN-EYE | sensory nexus | source candidate แบบ true-alpha รายละเอียดสูงอยู่ที่ `Generated-Assets/world/level_05_alien_eye_nexus/landmarks/awakened_sensory_nexus_v1.png`; บันทึกตาเมล็ดลำไย ม่านตากลีบแก้วมังกร สาย biomass ทางผ่านด้านล่าง hash และ provenance แล้ว แต่ยังขาด runtime scale, placement, occlusion, projectile readability และ performance validation | Review |
