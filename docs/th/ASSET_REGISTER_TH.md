...
| BOSS-ROOT-CORE-EYE | 5 | พวงตาลำไย + กลีบแก้วมังกร | fruit identity และ body source true-alpha ครบ 13 action/52 เฟรมอยู่ใน Review ที่ `Generated-Assets/bosses/root_core_eye/`; มี phase sealed/awakened/exposed, จุดยิงตายอด 5 จุดร่วมกับตากลาง, กลีบแก้วมังกรบอกทิศ, beam tell, hurt และ death pose ที่ลงพื้นถาวร พร้อม normalized grid, hash และ provenance; ยังขาด projectile/hazard, presentation, runtime integration, VFX/SFX และ gameplay validation | Review |
