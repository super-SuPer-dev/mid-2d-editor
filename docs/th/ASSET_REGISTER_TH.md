...
| BOSS-ROOT-CORE-EYE | 5 | พวงตาลำไย + กลีบแก้วมังกร | fruit-identity source และ body true-alpha 4 เฟรมชุดแรก 6 action อยู่ใน Review ที่ `Generated-Assets/bosses/root_core_eye/`: sealed idle, awakening, aimed seed cast, spiral cast, bract curtain และ radial-ring cast กำหนดจุดยิงตาลำไย 8 จุดและทิศกลีบแก้วมังกรที่อ่านง่าย; ยังขาด beam/exposed-core/hurt/death, projectile/hazard, presentation, runtime integration, VFX/SFX และ gameplay validation | Review |
...
| UI-BOSS-HUD | frame, portrait state และ phase marker แบบไม่มีข้อความของ Thorn Matriarch, Maw Sovereign, Possessed Banyan และ Root Hydra อยู่ใน Review ใต้ `Generated-Assets/bosses/*/presentation/`; ยังต้องทำ reusable runtime component และ skin ของ Root-Core Eye | Review |
| UI-BOSS-INTRO | intro frame และ portrait state แบบไม่มีข้อความของ Thorn Matriarch, Maw Sovereign, Possessed Banyan และ Root Hydra อยู่ใน Review; ยังต้องทำ presentation runtime ที่รองรับ localization และ skin ของ Root-Core Eye | Review |
