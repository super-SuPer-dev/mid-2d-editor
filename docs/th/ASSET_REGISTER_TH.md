...
| BOSS-ROOT-HYDRA | 4 | พวงลูกจาก | fruit-identity strip และ body source contract true-alpha ครบ 11 action อยู่ใน Review ที่ `Generated-Assets/bosses/root_hydra/`: 44 เฟรมครอบคลุม idle เกราะ/เปิดแกน, charge/crossfire/ring/lane cast, head/phase break, core attack, hurt และ death pose ถาวร พร้อมจุดยิง 4 หัวที่อ่านง่ายและ baseline ติดพื้น; ยังขาด projectile/hazard แยก, presentation, runtime integration, VFX/SFX และ gameplay validation | Review |
