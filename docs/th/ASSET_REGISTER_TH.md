...
| BOSS-MAW-SOVEREIGN | 2 | มงกุฎทุเรียน + กายมังคุด | ชุดตัวบอส true-alpha แบบละเอียด 12 action อยู่ใน Review ที่ `Generated-Assets/bosses/maw_sovereign/`: armored/exposed idle, move, bite tell/attack, spore/rotating/aimed/summon cast, phase break, hurt และ death บน cell 900 x 900; ยังขาด projectile/VFX แยก, portrait/HUD, runtime integration และ SFX | Review |
