...
| BOSS-ROOT-CORE-EYE | 5 | พวงตาลำไย + กลีบแก้วมังกร | fruit identity, body true-alpha 13 action/52 เฟรม และ projectile/telegraph/impact แยก 7 ชุดอยู่ใน Review ที่ `Generated-Assets/bosses/root_core_eye/`; จุดยิงตายอด 5 จุดร่วมกับตากลางรองรับ seed volley, spiral orb, ม่านกลีบ, radial tell, beam และ exposed-core shockwave พร้อม normalized grid, hash และ provenance; ยังขาด presentation, runtime integration, VFX/SFX ขั้นสุดท้าย และ gameplay validation | Review |
