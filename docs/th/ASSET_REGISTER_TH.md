...
| BOSS-ROOT-HYDRA | 4 | พวงลูกจาก | fruit-identity strip, body source contract true-alpha ครบ 11 action และ projectile/telegraph/impact แยก 7 ชุดอยู่ใน Review ที่ `Generated-Assets/bosses/root_hydra/`: body 44 เฟรมร่วมกับ wedge crossfire, nutrient-ring orb, muzzle/ring tell, water-lane eruption และ exposed-core beam/impact สร้างภาษากระสุน Touhou จาก 4 จุดยิง; ยังขาด presentation, runtime integration, VFX/SFX ขั้นสุดท้าย และ gameplay validation | Review |
