...
| BOSS-ROOT-HYDRA | 4 | พวงลูกจาก | fruit-identity strip และ body true-alpha 4 เฟรมชุดแรก 5 action อยู่ใน Review ที่ `Generated-Assets/bosses/root_hydra/`: idle, head-charge tell, alternating crossfire, offset radial-ring cast และ moving lane-wall cast กำหนดจุดยิง 4 หัวที่อ่านง่ายและ baseline ติดพื้น; ยังขาด head-break/exposed-core/hurt/death, projectile/hazard แยก, presentation, runtime integration, VFX/SFX และ gameplay validation | Review |
