...
| WORLD-L4-MARSH | Devouring Root Marsh | ชุด v2 ที่แก้เป็น pixel art แท้จริงอยู่ใน Review ที่ `art_source/generated/world/level_04_root_marsh/` มีชั้นหนองน้ำ/nipa/conduit 5 ชั้น, root-mat 7 ชิ้น, nutrient-root eruption 4 เฟรม, extraction beacon และ conduit landmark; บันทึก square pixel, ขอบขั้นบันได, limited ramp, alpha, frame gutter, hash และการ reject v1 แบบภาพวาดแล้ว แต่ยังขาด runtime slicing, collision, filtering, placement, memory และ validation 1280 × 720 | Review |
| WORLD-L5-NEXUS | Alien Eye Nexus | ชุด v2 ที่แก้เป็น pixel art แท้จริงอยู่ใน Review ที่ `art_source/generated/world/level_05_alien_eye_nexus/` มีชั้น impossible-depth/ตาลำไย/กลีบแก้วมังกร 5 ชั้น, source membrane/neural-root 7 ชิ้น, sensory platform 4 เฟรม, extraction beacon และ nexus landmark; บันทึก square-pixel construction, ขอบขั้นบันได, limited ramp, alpha, frame gutter, hash และการ reject v1 แบบภาพวาดแล้ว แต่ยังขาด runtime slicing, collision, filtering, placement, projectile readability, memory และ validation 1280 × 720 | Review |
...
| LANDMARK-ROOT-CONDUIT | nutrient conduit | candidate pixel art แท้จริงแบบ true-alpha คือ `art_source/generated/world/level_04_root_marsh/landmarks/root_nutrient_conduit_v2.png`; บันทึก scale ประตูชลประทาน ทางผ่านด้านล่าง บริบทสละ/nipa hash และการ reject v1 แล้ว แต่ยังขาด runtime placement, collision/readability และ performance validation | Review |
| LANDMARK-ALIEN-EYE | sensory nexus | candidate pixel art แท้จริงแบบ true-alpha คือ `art_source/generated/world/level_05_alien_eye_nexus/landmarks/awakened_sensory_nexus_v2.png`; บันทึกตาเมล็ดลำไย ม่านตากลีบแก้วมังกร สาย biomass ทางผ่านด้านล่าง hash และการ reject v1 แล้ว แต่ยังขาด runtime scale, placement, occlusion, projectile readability และ performance validation | Review |
